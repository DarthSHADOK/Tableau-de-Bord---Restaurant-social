...
class MainWindow(QMainWindow):
    ...
    def trigger_update_download(self, dialog_ref):
        # On pointe vers le ZIP de la dernière release
        url = "https://github.com/DarthSHADOK/Tableau-de-Bord---Restaurant-social/releases/latest/download/GestionResto.zip"
        temp_path = os.path.join(tempfile.gettempdir(), "GestionResto.zip") # .zip ici
