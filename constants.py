...
# ============================================================================
# 4. FEUILLE DE STYLE GLOBALE (CORRIGÉE)
# ============================================================================
# Dans constants.py, remplacez TOUTE la variable GLOBAL_STYLESHEET par ceci :
...
GLOBAL_STYLESHEET = f"""
    ...
    /* 1. Conteneur : Fond BLANC + Sans bordure */
    QScrollBar:vertical {{ 
        border: none;
        background: #ffffff;
        width: 14px;
    ...
    QScrollBar::handle:vertical {{ 
        ...
        /* CALCUL DU DÉCALAGE :
           Avant (Centré) : 0px 3px 0px 3px
           Maintenant (Gauche) : 0px 5px 0px 1px 
           (On enlève 2px à gauche, on ajoute 2px à droite)
        */
